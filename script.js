const CONFIG = {
    mainQuestion: "Ready to see your birthday surprise?",
    subQuestion: "I put all my heart into this, just for you ",
    yesButton: "SHOW ME!",
    noButton: "Not yet",
    noEscapeTexts: ["Eits, ga bisa😝", "Hehe, coba lagi 😜", "Yaudah deh, aku anggap YES ya! 💕"],
    confirmTitle: "YEAAY! It's Your Day 💗",
    confirmText: "Another year of you making the world a brighter place",
    badgeText: "Level 19 Unlocked!!!",
    nextButton: "Next",
    repeatButton: "Repeat",
    flowerTitle: "Mungkin untuk Birthday kali ini hadiah yang dikirim Tuhan untuk kamu itu ini heheheh ",
    takeBouquetButton: "AKUUU TERIMAA ",
    bouquetMessage: "Yeay! Udah jadi milik kamu 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Favorite Smile",
    collageSubtitle: "Just a few glimpses of the person who makes every single day feel like a celebration. 💕",
    nextCollageButton: "Selanjutnya… ",
...
function handleCopyMessage() {
   window.open(CONFIG.linkTujuan, '_blank');
}
